...
class ContourLevelGenerator:
    ...
    LINEAR_FIXED = 3
    USER_SPECIFIED = 4
    CLG_50 = 50  # EXPONENTIAL_DYNAMIC with interval 10
    CLG_51 = 51  # EXPONENTIAL_FIXED with interval 10
    CLG_60 = 60  # EXPONENTIAL_DYNAMIC with interval sqrt(10)
    CLG_61 = 61  # EXPONENTIAL_FIXED with interval sqrt(10)
